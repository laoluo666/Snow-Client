...
import snowclientMain.TextLogo;
...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    {
        GlStateManager.disableAlpha();
        String s = "Snow Client 1.8.8";
        drawDefaultBackground();
        
        final String menulogo = "Snow Client";
        TextLogo.drawString(5, menulogo, this.width / 10 - this.fontRendererObj.getStringWidth(menulogo) /2, this.height /20, Color.BLUE.getRGB());

        this.drawString(this.fontRendererObj, s, 2, this.height - 10, -1);
        String s1 = "By Laoluomc";
